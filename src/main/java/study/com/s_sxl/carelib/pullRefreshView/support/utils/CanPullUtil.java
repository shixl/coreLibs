package study.com.s_sxl.carelib.pullRefreshView.support.utils;
...
public class CanPullUtil {
    ...
    public static PullType getPullAble(View view) {
        if (view == null) {
            return null;
        }
        if (view instanceof PullType) {
            return (PullType) view;
    ...
    private static class AbsListViewCanPull implements PullType {
    ...
    private static class ScrollViewCanPull implements PullType {
    ...
    private static class RecyclerViewCanPull implements PullType {
    ...
    private static class WebViewCanPull implements PullType {
