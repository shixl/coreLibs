 ...
 */
package study.com.s_sxl.carelib.pullRefreshView.layout;
...
import study.com.s_sxl.carelib.pullRefreshView.support.utils.CanPullUtil;
...
public class FlingLayout extends FrameLayout implements NestedScrollingChild, NestedScrollingParent {
    ...
    private boolean canPullUp() {
        if (mPullView != null) {
            return canPullUp && pullType.isGetBottom();
        }
        return canPullUp;
    }
    ...
    private boolean canPullDown() {
        if (mPullView != null) {
            return canPullDown && pullType.isGetTop();
        }
        return canPullDown;
    }
    ...
    public void addView(View child, int index, ViewGroup.LayoutParams params) {
        if (mPullView == null && (pullType = CanPullUtil.getPullAble(child)) != null) {
            mPullView = child;
        }
    ...
    public boolean onNestedPreFling(View target, float velocityX, float velocityY) {
        ...
        PullType pullable = CanPullUtil.getPullAble(target);
        if (pullable != null) {
