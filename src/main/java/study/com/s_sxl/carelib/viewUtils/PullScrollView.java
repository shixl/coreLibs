...
public class PullScrollView extends ScrollView {
    ...
    public boolean onInterceptTouchEvent(MotionEvent event) {
        ...
        if (event.getAction() == MotionEvent.ACTION_DOWN) {
            ...
            mContentRect.set(mHeader.getLeft(), mHeader.getTop(), mHeader.getRight(), mHeader.getBottom());
            ...
            //不然子控件的行为就可能与我们的相冲突
            int deltaY = (int) ((int) event.getY() - mStartPoint.y);
            deltaY = deltaY > mHeader.getHeight() ? mHeader.getHeight() : deltaY;
